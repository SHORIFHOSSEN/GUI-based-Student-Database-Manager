...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        #Create status bar and the status bar elements
    ...
    def load_data(self):
        ...
        self.table.setRowCount(0) #Reset the table after to much run
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = (
            "This application was developed as part of the course "
            "'The Python Mega Course'.\n\n"
            "It is a personal study project created to showcase my work "
            "and skills in my CV."
        )
