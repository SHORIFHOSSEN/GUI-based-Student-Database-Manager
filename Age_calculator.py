from PyQt6.QtWidgets import QApplication, QLabel, QVBoxLayout,QLabel,QWidget,QGridLayout, \
...
class AgeCalculator(QWidget):
    ...
    def calculate_age(self):
        try:
            ...
            self.output_label.setText("Please enter a valid date in DD/MM/YYYY format")
